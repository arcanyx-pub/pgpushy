...
- **Documentation: running pgpushy in CI.** The README and spec §8.9 now point
  at [`arcanyx-pub/pgpushy-action`](https://github.com/arcanyx-pub/pgpushy-action),
  which serves the plan-artifact flow on GitHub Actions — plan under a preview
